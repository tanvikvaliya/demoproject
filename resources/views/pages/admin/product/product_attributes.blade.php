        ...
        <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('product_attributes.create')}}" class="btn btn-primary">Add Product Attribute</a>
                </div>  
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-hover" style="overflow-x:auto;">
                  ...
                  <tr>
                    <th>{{$pro->name}}</th>
                    <th><form id="submit-form" action="{{route('product_attributes.destroy',$pro->id) }}" method="post">
                    {{csrf_field()}}
                     {{ method_field('delete')}}<a class="fas fa-edit" href="{{route('product_attributes.edit',$pro->id)}}"></a>
